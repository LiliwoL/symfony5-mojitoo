...
class PlacesController extends AbstractController
{
    ...
    /**
     * @Route("/{lat}/{lng}/{format}", name="places_index_proximity", methods={"GET"})
     */
    public function indexProximity(float $lat, float $lng, string $format = 'full',  PlacesRepository $placesRepository): Response
    {
        $places = $placesRepository->findByGeoLoc($lat, $lng);
        ...
        switch ($format){
            case 'full':
                $twigFile = 'places/index.html.twig';
                $output = $this->render(
                    $twigFile,
                    [
                        'places' => $places,
            ...
            case 'json':
                $twigFile = 'places/_partials/index.html.twig';
                $html = $this->render(
                    $twigFile,
                        [
                            'places' => $places,
